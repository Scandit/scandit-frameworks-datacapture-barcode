Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-barcode.git', :tag => '6.19.0-beta.1' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditBarcodeCapture', '= 6.19.0-beta.1'
    s.dependency 'scandit-datacapture-frameworks-core', '= 6.19.0-beta.1'
end
